<?php
    ...
    if( isset( $error ) ) {
        ...
        $sql = "INSERT INTO products ( `product_name`, `product_description`,`product_price`,`image`,`category`,`status`,`user_id` ) VALUES
        ( :product_name, :product_description, :product_price, :image, :category, :status, :user_id )";
