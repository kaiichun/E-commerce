                            ...
                            <div class="text-center mb-3 g-3">
                                <div class="buttons">
                                    <a
                                        href="/products"
                                        target="_blank"
                                        class="btn btn-primary btn-fu me-2"
                                    >
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a
                                        href="/manage-products-edit?id=<?= $product['id']; ?>"
                                        class="btn btn-secondary btn-fu me-2"
                                    >
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-fu" data-bs-toggle="modal" data-bs-target="#delete-modal-<?= $product['id']; ?>">
